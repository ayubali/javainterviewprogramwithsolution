...
public class WeightedGraph {
	...
	public void setLabel(int vIndex, Object label) {
		labels[vIndex] = label;
	}

	public Object getLabel(int vIndex) {
		return labels[vIndex];
	}
	...
	public int[] neighbors(int vIndex) {
		int count = 0;
	...
	public static void main(String[] args) {
		...
		System.out.println("pred: " + Arrays.toString(Dijkstra.dist));
